...
public class WindowCapture {
	...
	public static void main(String[] args) throws AWTException, IOException, InterruptedException {
		listAllWindows();
		int hWnd = User32.instance.FindWindowA(null, "HTS2 ¦h©öÂI");
...
//		int hWnd = 264580;
	...
	private static void listAllWindows() throws AWTException, IOException, InterruptedException {
...
//				User32.instance.SetForegroundWindow(w.hwnd);
//				User32.instance.ShowWindow(w.hwnd);
//				User32.instance.BringWindowToTop(w.hwnd);
//				Thread.sleep(1000);
			}
	...
	public static class WindowInfo {
		...
		public String toString() {
			return String.format("(%d,%d)-(%d,%d) : [%d]\"%s\"", rect.left, rect.top, rect.right, rect.bottom, hwnd,
					title);
		}
	}
