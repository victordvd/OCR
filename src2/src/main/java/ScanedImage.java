...
//		BufferedImage fopimage = rescale.filter(ipimage, null);
//		ImageIO.write(fopimage, "png", new File("D:\\Tess4J\\Testing and learning\\output.png"));

		// Instantiating the Tesseract class
		// which is used to perform OCR
		Tesseract it = new Tesseract();

		it.setDatapath(System.getProperty("user.dir") + File.separator + "tessdata");
...
//		String str = it.doOCR(fopimage);
	...
	public static void main(String args[]) throws Exception {
		File f = new File("D:\\workplaces\\Spring-WS\\OpenCV\\OCR image\\tmp.png");
//		File f = new File("D:\\workplaces\\Spring-WS\\OpenCV\\OCR image\\ch.png");

		BufferedImage ipimage = ImageIO.read(f);
		
		Tesseract it = new Tesseract();
		it.setDatapath(System.getProperty("user.dir") + File.separator + "tessdata");
//		it.setLanguage("chi_tra");
		String str = it.doOCR(ipimage);
