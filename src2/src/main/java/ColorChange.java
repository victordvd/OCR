...
public class ColorChange {
	...
	public static void main(String[] args) throws Exception {
		int width = 512;
		int height = 512;
		File f = new File("D:\\workplaces\\Spring-WS\\OpenCV\\OCR image\\op.PNG");

		BufferedImage image = ImageIO.read(f);
		BufferedImage image2 = colorImage2(image);

		ImageIO.write(image2, "png", new File("D:\\workplaces\\Spring-WS\\OpenCV\\OCR image\\tmp.png"));
		/*
	...
	private static BufferedImage colorImage2(BufferedImage image) {
